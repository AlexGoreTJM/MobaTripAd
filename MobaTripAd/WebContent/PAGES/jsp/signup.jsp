		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="text-center">
					<img src="/MobaTripAd/IMGDB/Utente/MOBAavatar.png"
						class="avatar img-circle" alt="avatar" height="256" width="256">
			...
			<div class="col-md-9 personal-info">
				...
				<form class="form-horizontal" role="form" action="signup.do"
					method="post">
					...
					<div class="form-group">
						...
						<div class="col-lg-8">
							...
							<div class="erroriWithe">
								<html:errors property="email" bundle="errori" />
							</div>
						</div>
