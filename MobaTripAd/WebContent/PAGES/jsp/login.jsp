									...
									<div class="col-sm-12 col-md-10  col-md-offset-1 ">
										<div class="form-group">
											<div class="input-group">
												...
												<div class="form-control">
													<html:text name="LoginForm" property="username" style="color:black; border-style:none; width: 100%;height: 20px;" />
												</div>
											</div>
											<div class="errori">
										...
										<div class="form-group">
											<div class="input-group">
												...
												<div class="form-control">
													<html:password name="LoginForm" property="password" style="color:black; border-style:none; width: 100%;height: 20px;" />
												</div>
											</div>
											<div class="errori">
