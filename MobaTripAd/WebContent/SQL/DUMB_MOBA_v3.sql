...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "MOBA"."GIOCO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 4 NOCACHE  ORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence UTENTE_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "MOBA"."UTENTE_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 ORDER  NOCYCLE ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into MOBA.CATEGORIA (IDCATEGORIA,NOME,IMG,INFO) values ('1','RPG',null,'Role Play Game (Gioco di ruolo)');
Insert into MOBA.CATEGORIA (IDCATEGORIA,NOME,IMG,INFO) values ('2','MOBA',null,'Multiplayer Online Battle Arena');
Insert into MOBA.CATEGORIA (IDCATEGORIA,NOME,IMG,INFO) values ('3','FPS',null,'Fragment Per Second (Sparatutto)');
Insert into MOBA.CATEGORIA (IDCATEGORIA,NOME,IMG,INFO) values ('4','Strategy Game',null,null);
Insert into MOBA.CATEGORIA (IDCATEGORIA,NOME,IMG,INFO) values ('5','Graphic Adventure',null,'Avventura grafica: punta e clicca!');
Insert into MOBA.CATEGORIA (IDCATEGORIA,NOME,IMG,INFO) values ('6','Drive simulation',null,null);
Insert into MOBA.CATEGORIA (IDCATEGORIA,NOME,IMG,INFO) values ('7','Fly Simulation',null,null);
Insert into MOBA.CATEGORIA (IDCATEGORIA,NOME,IMG,INFO) values ('8','Action Adventure',null,'Azione avventurosa');
Insert into MOBA.CATEGORIA (IDCATEGORIA,NOME,IMG,INFO) values ('9','Sport',null,null);
Insert into MOBA.CATEGORIA (IDCATEGORIA,NOME,IMG,INFO) values ('10','Platform',null,'Arcade');
Insert into MOBA.CATEGORIA (IDCATEGORIA,NOME,IMG,INFO) values ('11','Survivor Horror',null,null);
Insert into MOBA.CATEGORIA (IDCATEGORIA,NOME,IMG,INFO) values ('12','Fight',null,'Picchiaduro!');
Insert into MOBA.CATEGORIA (IDCATEGORIA,NOME,IMG,INFO) values ('13','MMORPG',null,'Massive Multiplayer Online RPG');
REM INSERTING into MOBA.GIOCO
SET DEFINE OFF;
Insert into MOBA.GIOCO (IDGIOCO,TITOLO,SH,PLAYERS,WEB,DATAUSCITA,ETAMIN,COSTOLANCIO,IDCATEGORIA,VALUTAZIONESITO,PRO,CONTRO,IMG1,IMG2,URLVIDEO,URLSH,REQUISITI,INFO,DATAREG) values ('1','WARCRAFT III','Blizzard','1','1',to_date('03-LUG-02','DD-MON-RR'),'12','59,9','1','9','pro','contro','moba.jpg',null,null,null,'entium 2 o sup',null,to_timestamp('08-MAR-16 10:30:26,846000000','DD-MON-RR HH24:MI:SSXFF'));
Insert into MOBA.GIOCO (IDGIOCO,TITOLO,SH,PLAYERS,WEB,DATAUSCITA,ETAMIN,COSTOLANCIO,IDCATEGORIA,VALUTAZIONESITO,PRO,CONTRO,IMG1,IMG2,URLVIDEO,URLSH,REQUISITI,INFO,DATAREG) values ('2','Clash Of Clans','SUPERCELL','1','1',to_date('07-OTT-13','DD-MON-RR'),'7','0','4','8','pro','contro','moba.jpg',null,null,null,null,null,to_timestamp('09-MAR-16 12:37:45,846000000','DD-MON-RR HH24:MI:SSXFF'));
Insert into MOBA.GIOCO (IDGIOCO,TITOLO,SH,PLAYERS,WEB,DATAUSCITA,ETAMIN,COSTOLANCIO,IDCATEGORIA,VALUTAZIONESITO,PRO,CONTRO,IMG1,IMG2,URLVIDEO,URLSH,REQUISITI,INFO,DATAREG) values ('3','FIFA16','EA','8','1',to_date('24-SET-15','DD-MON-RR'),'6','69,99','9','7','Realistico','Difficile giocabilità','moba.jpg',null,null,null,null,null,to_timestamp('09-MAR-16 12:41:13,838000000','DD-MON-RR HH24:MI:SSXFF'));
...
SET DEFINE OFF;
Insert into MOBA.RECENSIONE (IDUTENTE,IDGIOCO,CTRLIKE,CTRDISLIKE,SEGNALATA,INFO,DATAREC) values ('1','1','5','2','0','bellooo',to_timestamp('11-MAR-16 16:28:42,722000000','DD-MON-RR HH24:MI:SSXFF'));
Insert into MOBA.RECENSIONE (IDUTENTE,IDGIOCO,CTRLIKE,CTRDISLIKE,SEGNALATA,INFO,DATAREC) values ('1','3','2','5','0','wow',to_timestamp('07-MAR-16 16:29:33,661000000','DD-MON-RR HH24:MI:SSXFF'));
Insert into MOBA.RECENSIONE (IDUTENTE,IDGIOCO,CTRLIKE,CTRDISLIKE,SEGNALATA,INFO,DATAREC) values ('2','1','45','32','0','ee',to_timestamp('15-MAR-16 16:29:54,343000000','DD-MON-RR HH24:MI:SSXFF'));
REM INSERTING into MOBA.UTENTE
SET DEFINE OFF;
Insert into MOBA.UTENTE (IDUTENTE,ADMIN,NICKNAME,EMAIL,PASSWORD,NOME,COGNOME,GRADO,AVATAR,DATAREG,INFO) values ('1','1','admin','admin@moba.it','admin','Alessandro','Galiano','Peone','moba_avatar.jpg',to_timestamp('09-MAR-16 12:13:13,708000000','DD-MON-RR HH24:MI:SSXFF'),null);
Insert into MOBA.UTENTE (IDUTENTE,ADMIN,NICKNAME,EMAIL,PASSWORD,NOME,COGNOME,GRADO,AVATAR,DATAREG,INFO) values ('2','0','nitro','nitrotodabeat@gmail.com','nitronitro','Guglielmo','Faiola','Scudiero','moba_avatar.jpg',to_timestamp('09-MAR-16 12:16:17,604000000','DD-MON-RR HH24:MI:SSXFF'),'Sono esplosivo!');
REM INSERTING into MOBA.VALUTAZIONE
SET DEFINE OFF;
Insert into MOBA.VALUTAZIONE (IDUTENTE,IDGIOCO,VOTO) values ('1','1','5');
Insert into MOBA.VALUTAZIONE (IDUTENTE,IDGIOCO,VOTO) values ('2','1','7');
Insert into MOBA.VALUTAZIONE (IDUTENTE,IDGIOCO,VOTO) values ('1','2','5');
