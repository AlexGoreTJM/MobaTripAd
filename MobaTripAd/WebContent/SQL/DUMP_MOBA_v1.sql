--------------------------------------------------------
--  File creato - mercoledì-marzo-09-2016   
--------------------------------------------------------
...
Insert into MOBA.UTENTE (IDUTENTE,ADMIN,NICKNAME,EMAIL,PASSWORD,NOME,COGNOME,GRADO,AVATAR,DATAREG,INFO) values ('2','0','nitro','nitrotodabeat@gmail.com','nitro','Guglielmo','Faiola','Scudiero','moba_avatar.jpg',to_timestamp('09-MAR-16 12:16:17,604000000','DD-MON-RR HH24:MI:SSXFF'),'Sono esplosivo!');
