...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "MOBA"."UTENTE_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 102 CACHE 20 ORDER  NOCYCLE ;
--------------------------------------------------------
...
Insert into MOBA.SHOP (IDGIOCO,LINK,IDPIATTAFORMA) values ('4','www.amazon.it/Square-Enix-SP3T26-Tomb-Raider/dp/B007SN62I6/ref=sr_1_3?ie=UTF8&qid=1458229712&sr=8-3&keywords=tomb+raider','3');
...
Insert into MOBA.UTENTE (IDUTENTE,ADMIN,NICKNAME,EMAIL,PASSWORD,NOME,COGNOME,GRADO,AVATAR,DATAREG,INFO) values ('4','0','crascioni','c.rascioni@gmail.com','Password1','Christian','Rascioni','Capitano','MOBAavatar.png',to_timestamp('11-MAR-16 16:49:41,568000000','DD-MON-RR HH24:MI:SSXFF'),null);
Insert into MOBA.UTENTE (IDUTENTE,ADMIN,NICKNAME,EMAIL,PASSWORD,NOME,COGNOME,GRADO,AVATAR,DATAREG,INFO) values ('5','0','skyzzo','skyzzo.matteo@gmail.com','Password1','Matteo','Di Girolamo','Generale','MOBAavatar.png',to_timestamp('11-MAR-16 16:53:42,563000000','DD-MON-RR HH24:MI:SSXFF'),'Il mio nick mi precede! ;)');
...
Insert into MOBA.UTENTE (IDUTENTE,ADMIN,NICKNAME,EMAIL,PASSWORD,NOME,COGNOME,GRADO,AVATAR,DATAREG,INFO) values ('61','0','Removed','kuno98200@yahoo.it','Password2','Riccardo','Rossi','Peone','MOBAavatar.png',to_timestamp('17-MAR-16 17:39:42,857000000','DD-MON-RR HH24:MI:SSXFF'),null);
Insert into MOBA.UTENTE (IDUTENTE,ADMIN,NICKNAME,EMAIL,PASSWORD,NOME,COGNOME,GRADO,AVATAR,DATAREG,INFO) values ('83','0','skyzzo12','skyzzo@christian.com','porcaccialatroia','Matteo','Matteo','Peone','moba.jpg',to_timestamp('18-MAR-16 10:58:11,987000000','DD-MON-RR HH24:MI:SSXFF'),null);
